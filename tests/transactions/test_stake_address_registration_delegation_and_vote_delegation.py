...
from pccontext.transactions.stake_address_registration_delegation_and_vote_delegation import (
...
def test_stake_address_registration_delegation_and_vote_delegation_success(
    chain_context, drep_kind, drep_id
):
    """
    Test successful stake address registration and stake delegation and vote delegation.
    """
    ...
    transaction = stake_address_registration_delegation_and_vote_delegation(
        chain_context, vk, pool_id, address, drep_kind, drep_id
    )
